...
public class DocumentoTest {
	...
	public void deberiaComprobarGetters() {
		Documento documento1 = new Documento(1, "Factura", FECHA, true, EstadoDocumento.APROBADO, new Date(1/1/2010));
	...
	public void deberiaDevolverTrueSiTienenIgualCodigo() {
		Documento documento1 = new Documento(1, "Factura", FECHA, true, EstadoDocumento.APROBADO, new Date(1/1/2010));
		Documento documento2 = new Documento(1, "Factura", FECHA, true, EstadoDocumento.APROBADO, new Date(1/1/2010));
	...
	public void deberiaDevolverFalseSiNoTienenIgualCodigo() {
		Documento documento1 = new Documento(1, "Factura", FECHA, true, EstadoDocumento.APROBADO, new Date(1/1/2010));
		Documento documento2 = new Documento(2, "Factura", FECHA, true, EstadoDocumento.APROBADO, new Date(1/1/2010));
